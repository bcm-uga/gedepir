...
[[https://figshare.com/articles/dataset/Database_for_enrichment_analysis/16546470]]
  ...
  + 'Tissue.markers.RDS' Tissue database : 906 markers list  for 110 organs
  + 'Cancer.markers.RDS'  Cancer database : 325 markers lists for 33 cancer types
  + 'Tissue.CellTypes.markers.RDS'   : Tissue + Cancer database
  + 'Cancer_Cell_Lines.RDS' : NCI-60 Human Tumor Cell Lines Screen
  + 'GTEx.RDS' Genotype-Tissue Expression project, specific expression (up and down) for 2918 tissue samples
  + 'Reactome_2016.RDS' : Reactome pathway database
  + 'GO.DB.RDS' : Gene Ontology database,  annotation for functions of genes
  + 'KEGG_2019_Human.RDS' :  Kyoto Encyclopedia of Genes and Genomes database, high-level annotations from molecular-level information
